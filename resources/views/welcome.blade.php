...
<div class="container">
    <div class="d-flex justify-content-center">
        <div class="flex-column text-center">
            <img class="rounded-circle mt-0 mb-2" alt="Liz Masters" src="/storage/images/profile.png" height="80" width="80">
    ...
    <div class="d-flex-justify-content-center">
        <p class="text-muted text-center mb-0">Copyright © {{date('Y')}} Liz Masters</p>
        <p class="text-muted text-center mt-0"><small>Site Created with &#9829; by <a href="http://andrewbeatrice.com">Andrew Beatrice</a></small></p>
    </div>
